...
// items[i] = [IDi, scorei] represents one score from a student 
// with IDi, calculate each student's top five average.

// Return the answer as an array of pairs result, where 
// result[j] = [IDj, topFiveAveragej] represents the student with 
